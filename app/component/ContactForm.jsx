...
function ContactForm() {
  ...
  const handleSubmit = (e) => {
    ...
    const mailtoLink = `mailto:      Freshspecialisthospital@gmail.com
?subject=Message from ${formData.name}&body=Name: ${formData.name}%0D%0AEmail: ${formData.email}%0D%0A%0D%0AMessage:%0D%0A${formData.message}`;
  ...
  return (
    <div className="bg-white p-8 rounded-lg shadow-lg animate-fade-in">
      ...
      <p className="mt-4 text-sm text-blue-600 text-center">
        ...
        <a 
          href="mailto:      Freshspecialisthospital@gmail.com
"
