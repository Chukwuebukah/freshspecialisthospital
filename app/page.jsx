      ...
      <section className="mb-20">
        ...
        >
          ...
          <p className="text-gray-600 mb-8">
            We are proud to work with these trusted health insurance providers
          </p>

          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            {[
              { name: "Reliance HMO", logo: "/reliance.png" },
              { name: "Leadway Health", logo: "/lead.png" },
              { name: "Hygeia HMO", logo: "/hygeia.jpeg" },
              { name: "Avon HMO", logo: "/avon.png" },
            ].map((hmo, idx) => (
              <motion.div
                key={idx}
                initial={{ opacity: 0 }}
                ...
                transition={{ delay: idx * 0.2 }}
                className="w-36 h-24 bg-white rounded-lg shadow-md p-3 flex items-center justify-center"
              >
                <img
                  src={hmo.logo}
                  alt={`${hmo.name} logo`}
                  ...
                  onError={(e) => {
                    ...
                    e.target.src =
                      "https://via.placeholder.com/150x80?text=" + hmo.name;
                  }}
                />
              </motion.div>
            ))}
...
{/* Core Values, About, and Strength Section */}
<section className="mb-20">
